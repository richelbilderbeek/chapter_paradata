...
This is an excellent point and I have reworded to clarify this, 
e.g. 'if [in the rare case] code is supplied, it is pasted in the Supmat'.
...
The reviewer is right: I wrote 'Paradata does not have a clear definition yet (hence this book)' 
from hearsay at the meeting. I added a referenced definition:
