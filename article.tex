...
% \paragraph{The earliest definition of paradata}

Paradata are data about the data collection process \cite{choumert2019using}.
...
Given the stance that code to do a computational experiment is paradata, 
the effect of its absence is 
that a computational experiment cannot be redone easily.
...
instead focussing on 'computational experiment' first.
