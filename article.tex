...
The reasons why paradata in the form of code matters, 
are the same reaons as why paradata matters,
which are data reuse, research reproducibility, 
...
This chapter will focus mostly on the goals of making science
reproducible and code reusable.
...
% d: Documentation as a Factor for Project Popularity
%
% There exists a clear relationship between the popularity and the documentation effort [62], [64], [65]. 
% cosentino2017systematic
