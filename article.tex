...
\subsubsection{Code must be clean}

Code gives an indication of the quality 
...
There exist website that are dedicated to host code.
Such so-called code hosting websites have many advantages,
both for the authors and users of the code,
over copy-pasting code in the supplementary materials in a paper.


The practice of using a code hosting websote has increased,
...
\paragraph{Example of code hosting website}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Making code FAIR data}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
