...
\begin{verbatim}
We compared the values of x and y using an unpaired one-tailed Student's T-test,
...
To approach the same problem from a different angle:
correctly reporting the T-test in a reproducable ways
is already a problem, with only 80 out of a selected 179 papers
