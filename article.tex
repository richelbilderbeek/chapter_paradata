...
and instead of ignoring that, it should be embraced \cite{beck2000extreme}.
...
However, 57\% out of 56 Science magazine corresponding authors 
that shared their code has documented their code well enough to run it 
...
It is the practice of writing a document mixed with code that 
will be run.
