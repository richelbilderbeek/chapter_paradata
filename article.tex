...
In general, it appears that sharing code is rare \cite{stodden2011trust,read2015sizing}.
...
which is that they may be contacted with a user sending in a bug report.
HIERO
